...
def prepare_data(vocab_dir, from_train_path, to_train_path, from_dev_path, to_dev_path, from_vocabulary_size,
                 to_vocabulary_size, tokenizer=None):
  """Preapre all necessary files that are required for the training.

    Args:
      vocab_dir: directory in which the vocab data set will be stored.
  ...
  to_vocab_path = os.path.join(vocab_dir, "vocab%d.to" % to_vocabulary_size)
  from_vocab_path = os.path.join(vocab_dir, "vocab%d.from" % from_vocabulary_size)
